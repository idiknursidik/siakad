...
class Profilpt extends BaseController
{
	...
	public function form()
	{
		...
		echo "<input type='hidden' name='logo lama' value='{}'";	
		echo csrf_field();
		  ...
		  echo "<div class='form-group row'>";
			echo "<div class='col-sm-2'>";
				echo "<img src='".base_url()."/public/gambar/{$logopt}' class='profile-user-img img-fluid img-circle img-preview'>"; //img-thumbnail;
			echo "</div>";
			...
			echo "</div>";
		  echo "</div>";
		echo "<hr><button type='submit' name='kirim' class='btn bg-primary'>Proses data</button>";
		echo "</form>";		
	}
	public function simpan(){
		...
		{			
			...
			$cekdata = $this->msiakad_setting->getdata();
