...
class Profile extends BaseController
{
	...
	protected $siakad_akun = 'siakad_akun_dosen';
	...
	public function viewdata()
	{
		...
		if($this->request->isAJAX()){
			...
			echo "<form class='form-horizontal' id='form_editprofile' method='post' action='".base_url()."/dosen/profile/updateprofile'>";
			...
			echo "<div class='form-group row'>";
				...
				echo "<div class='col-sm-10'>";
				  echo "<input type='text' name='nama' class='form-control' id='nama' placeholder='Nama' readonly value='{$infoakun->nama_dosen}'>";
				echo "</div>";
			echo "</div>";
			echo "<div class='form-group row'>";
			...
			echo "<form class='form-horizontal' id='form_editpassword' method='post' action='".base_url()."/dosen/profile/updatepassword'>";
			echo "<div class='form-group row'>";
			...
			echo "<form class='form-horizontal' method='post' id='form_profile_image' action='".base_url()."/dosen/profile/updateimage' enctype='multipart/form-data' class='d-inline'>";	
			echo csrf_field();			 
			  echo "<div class='form-group row'>";
	...
	public function updatepassword(){
		if($this->request->isAJAX()){
			...
			if(!$valid){
				...
				//cek password lama
				$datalama = $this->msiakad_akun->getakundosen(false,session()->username);
