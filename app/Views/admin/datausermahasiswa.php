...
<div class="row no-print">
	<div class="col-12">
	  ...
	  <a href="#modalku" data-toggle="modal" title="Tambah Akun" data-src="<?php echo base_url();?>/admin/datausermahasiswa/tambah" class="btn btn-success float-right modalButton"><i class="far fa-credit-card"></i> Tambah data</a>	
	</div>
</div>
<br>
