...
<div class="row no-print">
	<div class="col-12">
	  ...
	  <a href="#modalku" data-toggle="modal" title="Tambah Kelas" data-src="<?php echo base_url();?>/akademik/nilai/tambah" class="btn btn-success float-right modalButton"><i class="far fa-credit-card"></i> Tambah data</a>
...
$(function(){
	...
	$("a[name='getnilaipddikti']").on("click",function(){
		...
		$.get(action, function( data ) {		  
			...
			$("a[name='getnilaipddikti']").html("<i class='fas fa-download'></i> Ambil dari PDDIKTI").removeClass("disabled");
		},'json')
		return false;
	})
