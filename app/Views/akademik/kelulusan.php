...
<div class="row no-print">
	<div class="col-12">
	  ...
	  <a href="#modalku" data-toggle="modal" title="Tambah Data Excel" data-src="<?php echo base_url();?>/akademik/kelulusan/tambah" class="btn btn-success float-right modalButton"><i class="far fa-credit-card"></i> Tambah data</a>
