...
<div class="row no-print">
	<div class="col-12">
	  ...
	  <?php
		if(session()->level == 1){
	  ?>
	  <a href="#" name="getmatakuliahpddikti" id="btnGet_getmatakuliahpddikti" data-src="<?php echo base_url();?>/akademik/matakuliah/getmatakuliahpddikti" class="btn btn-primary float-right" style="margin-right: 5px;">
